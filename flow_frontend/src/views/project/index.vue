	...
	<div class="project-container" style="padding-top: 50px;">
		<el-row justify="center" type="flex">
			<el-col :span="18">
				...
				<el-table
					:data="search ? search_project_list : project_list"
					...
					<el-table-column label="项目名">
						<template slot-scope="scope">
							<el-link @click="jumpToGraph(scope.row.id, scope.row.project_name)">
...
<script>
    ...
    export default {
        ...
        methods: {
			 ...
			 * 跳转到图详情界面
			 */
            jumpToGraph(graphId, graphName) {
                this.$store.commit('app/SetGraphName', graphName)
