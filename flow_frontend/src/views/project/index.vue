	...
	<div class="project-container" style="padding-top: 50px;">
		<el-row justify="center" type="flex">
			<el-col :span="18">
				<div class="action-group">
					<el-row justify="space-between" type="flex">
						<el-col class="action-group-left">
							<el-button :disabled="!multipleSelection.length" @click="deleteProjects" circle class="action-btn" icon="el-icon-delete"
							 type="danger" size="small"></el-button>
							<el-button :disabled="!multipleSelection.length" @click="copyProjects" circle class="action-btn" icon="el-icon-copy-document"
				...
				<el-table :data="project_list" @selection-change="handleSelectionChange" border highlight-current-row style="width: 100%"
				 v-loading="loading">
				...
				<!-- 分页器 -->
				<div class="paginator">
					<el-pagination :current-page="listQuery.page" :page-size="listQuery.page_size" :page-sizes="[10, 20]" :total="count"
					 @current-change="pageCurrentChange" @size-change="pageSizeChange" layout="total, sizes, prev, pager, next, jumper"
					 style="text-align: center" />
				</div>
			</el-col>
		</el-row>

		<el-dialog :append-to-body="false" :close-on-click-modal="false" :modal-append-to-body="true" :visible.sync="isShowDialog"
		 custom-class="preview-dialog" title="创建项目">
			...
			<div class="dialog-footer" slot="footer">
				<el-button :disabled="form.projectName === '' || form.owner === ''" @click="createProject" type="primary">完 成
				</el-button>
			</div>
		</el-dialog>
	</div>
